...
```{r}
son_water <- read_rds(here("outputs", "sbtn_son_water_v1_1.rds"))
```
...
```{r}
write_rds(son_water_adm0, here("outputs", "adm_level", "sbtn_son_water_v1_1_adm0.rds"))
```
...
```{r}
write_rds(son_water_adm1, here("outputs", "adm_level", "sbtn_son_water_v1_1_adm1.rds"))
```
...
```{r}
son_water_adm0 <- read_rds(here("outputs", "adm_level", "sbtn_son_water_v1_1_adm0.rds"))
son_water_adm1 <- read_rds(here("outputs", "adm_level", "sbtn_son_water_v1_1_adm1.rds"))
```
