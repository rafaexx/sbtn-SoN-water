...
```{r}
wsb_weights <- list(
  rast(here("inputs", "blue_water_footprint", "sectoral", "wfbl_agr_m3y", "w001001.adf")),
  rast(here("inputs", "blue_water_footprint", "sectoral", "wfbl_dom_m3y", "w001001.adf")),
  rast(here("inputs", "blue_water_footprint", "sectoral", "wfbl_ind_m3y", "w001001.adf")),
  rast(here("inputs", "blue_water_footprint", "total", "wfbl_yr_30m", "w001001.adf"))
) |> 
